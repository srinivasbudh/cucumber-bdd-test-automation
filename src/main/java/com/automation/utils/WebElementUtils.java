 ...
 * Assertion Utils : Utility methods for making selenium methods more readable and easily understandable
 */

public class WebElementUtils {
    static Long timeout = Long.parseLong("15");
    ...
    public static void makeExecutionWait(){
        try {
            Thread.sleep(3000);
